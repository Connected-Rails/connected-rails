...
sig-motion-profile = Verlauf
sig-motion-linear = linear
sig-motion-semaphore = mechanisches Formsignal
sig-fall-seconds = Fallzeit
sig-fall-seconds-hint = schwerkraftgetriebene Zeit vom vollen Ausschlag bis zum Anschlag
sig-rebound = Rückprall
sig-rebound-hint = Stoßzahl am mechanischen Anschlag — 0 bedeutet kein Nachhüpfen
sig-mount = Montage
...
tool-select-hint = Klick wählt Einzelnes aus — das Gleis, das er träfe, leuchtet unter dem Cursor auf · Strg+Klick sammelt eine Mehrfachauswahl, ein zweiter Strg+Klick nimmt es wieder heraus · auf freiem Boden drücken und ziehen wählt im Kreis · ein gewähltes Gleis zeigt seine runden Griffe, ein freier Anfang sein Verschiebe-/Dreh-Gizmo (W/E) · Entf löscht die Auswahl
...
tool-gradient-hint = Klick auf ein Gleis setzt dort einen Neigungswechsel. Einen Neigungswechsel anfassen und die Maus auf dem Bildschirm nach oben oder unten bewegen hebt oder senkt ihn — die Abschnitte beiderseits ändern ihre Promille, alle anderen Punkte bleiben. Das Auswahlpanel stellt die Zahlen ein
...
lay-formation = Schotterbett & Bahndamm
lay-formation-hint = An (Standard) baut das Gelände den Bahnkörper unter dem Stück — Schotterbett, Damm oder Einschnitt. Aus: nur die Schienen stehen, für Brücken, Bahnsteige oder selbst geformten Untergrund
...
hover-edge-start = Gleisanfang · Richtung { $heading }°
...
sel-edge-handles = Die runden Griffe auf der Karte verschieben — so biegt sich das Gleis. Bei freiem Anfang verschiebt das Gizmo das ganze Gleis (W) oder dreht es um seinen Anfang (E).
...
sel-edge-formation = Schotterbett & Bahndamm
sel-edge-formation-hint = Aus: das Gelände lässt dieses Gleis in Ruhe — kein Schotterbett, kein Damm, kein Schotterstreifen. Für Gleise auf eigenen Konstruktionen; teile das Gleis, wenn nur ein Stück schwebt
sel-track-type = Gleisart
sel-track-type-none = Keine Gleisart — das Gleis muss eine nennen, es springt keine ein.
...
track-type-none-installed = Kein installierter Mod definiert eine Gleisart
...
signal-label = { $designation } · { $kind } (Gerät { $device }, Index { $index })
sig-designation = Signalbezeichnung
sig-designation-hint = Eindeutige betriebliche Bezeichnung auf der Tafel am Signal, z. B. A, N1 oder 47P3
sig-interlocking = Stellwerk
sig-interlocking-hint = Bezeichnung des Stellwerks, das dieses Signal bedient
sig-kind = Art
...
sig-addons = Zusatzsignale
sig-addons-hint = Physisch vorhandene Anbauten dieses Signals. Über + lassen sich mehrere fahrstraßenabhängige Kennbuchstaben oder Kennziffern desselben Lichtanzeigers eintragen.
sig-addons-not-applicable = An Rangiersignalen und Gleissperren sind diese Zusatzsignal-Anbauten nicht zulässig.
sig-addons-invalid = Diese Auswahl enthält eine unzulässige Funktion, einen leeren Wert oder Zs 13 zusammen mit Zs 3 Kennziffer 1–3.
sig-fitted = vorhanden
sig-zs-form = Formtafel
sig-zs-light = Lichtanzeiger
sig-zs-a-lights = drei Lichter (A)
sig-zs-blink-light = ein Blinklicht
sig-zs-light-strip = blinkender Lichtstreifen
sig-zs-values = Kennbuchstabe, z. B. K
sig-zs-add-letter = Weiteren fahrstraßenabhängigen Kennbuchstaben hinzufügen
sig-zs-add-value = Weitere fahrstraßenabhängige Kennziffer
sig-zs1 = Zs 1 Ersatzsignal
sig-zs1-hint = Drei weiße Lichter in A-Form oder ein weißes Blinklicht; am haltzeigenden Hauptsignal
sig-zs2 = Zs 2 Richtungsanzeiger
sig-zs2-hint = Weiß leuchtender Kennbuchstabe; über + lassen sich mehrere mögliche Buchstaben eintragen
sig-zs2v = Zs 2v Richtungsvoranzeiger
sig-zs2v-hint = Gelb leuchtender Kennbuchstabe am Vorsignal bzw. an der Vorsignalfunktion
sig-zs3 = Zs 3 Geschwindigkeitsanzeiger
sig-zs3-hint = Weiße Kennziffer; der zehnfache Wert gilt in km/h. Formtafel: eine feste Kennziffer, Lichtanzeiger: mehrere möglich
sig-zs3v = Zs 3v Geschwindigkeitsvoranzeiger
sig-zs3v-hint = Gelbe Kennziffer am Vorsignal bzw. an der Vorsignalfunktion
sig-zs6 = Zs 6 Gegengleisanzeiger
sig-zs6-hint = Weißer, von rechts nach links steigender Streifen als Formtafel oder Lichtanzeiger
sig-zs7 = Zs 7 Vorsichtsignal
sig-zs7-hint = Drei gelbe Lichter in V-Form am Hauptsignal
sig-zs8 = Zs 8 Gegengleisfahrt-Ersatzsignal
sig-zs8-hint = Drei weiß blinkende Lichter in A-Form oder ein weiß blinkender Lichtstreifen
sig-zs12 = Zs 12 M-Tafel
sig-zs12-hint = Weiße Tafel mit rotem Rand und rotem Schreibschrift-M am Hauptsignal
sig-zs13 = Zs 13 Stumpfgleis-/Frühhaltanzeiger
sig-zs13-hint = Liegendes gelbes T; nicht zusammen mit Zs 3 Kennziffer 1, 2 oder 3 anwenden
sig-zs103 = Zs 103 Rautentafel (DV 301)
sig-zs103-hint = Historische schwarze Tafel mit weißen Rauten am Hauptsignal; nur für DV-301-Szenarien
...
veg-species = Art
veg-species-hint = 3D-Objekt eines Mods (objects/*.ron) oder ein Bestand aus dessen `stand-…`-Tags — der Waldpinsel mischt dessen Arten; der Platzhalter ist der eingebaute Baum der App
veg-placeholder = (Platzhalter-Baum)
veg-stands = Bestände
veg-single = Einzelne Arten
tree-yaw = Rotation
...
road-import-tracks-hint = Auch highway=track importieren — die Wirtschaftswege, mit denen ein Agrarmodul vernäht ist. Sie kommen unbefestigt herein, außer der Mapper hat einen Belag oder tracktype=grade1 eingetragen
...
road-preset = Straßentyp
road-preset-hint = Welche Klasse des deutschen Straßennetzes die nächste ist — sie setzt Breite, Belag und Markierung, und alle drei bleiben editierbar
road-preset-motorway-3 = Autobahn, 3 Fahrstreifen + Standstreifen
road-preset-motorway = Autobahn, 2 Fahrstreifen + Standstreifen
road-preset-motorway-concrete = Autobahn, 2 Fahrstreifen + Standstreifen (Beton)
road-preset-federal = Bundes-/Landstraße außerorts
road-preset-federal-solid = Landstraße mit Überholverbot
...
road-preset-farm-gravel = Feldweg (Schotter)
road-preset-farm-concrete = Feldweg (Betonplatten)
road-preset-path = Fußweg
road-name = Name
road-name-hint = Wie die Straße in der Datei und diesem Panel heißt; der OSM-Import übernimmt es aus der Karte
road-width = Breite
road-width-hint = Bordstein zu Bordstein — der Wert der Vorlage ist ein Planungswert, und das Modul darf anderer Meinung sein
road-surface = Belag
road-surface-hint = Womit die Fahrbahn gezeichnet wird; der OSM-Import liest ihn aus surface=* und tracktype=*
road-surface-asphalt = Asphalt
road-surface-concrete = Beton
road-surface-gravel = Schotter
road-center-line = Mittellinie
road-center-line-hint = Was in der Mitte läuft, nach RMS: gestrichelt 6-und-12 außerorts, 3-und-6 innerorts, oder die durchgezogene Linie
road-edge-lines = Randlinien
road-edge-lines-hint = Die durchgezogenen weißen Seitenlinien an den Fahrbahnrändern — eine befestigte Straße trägt sie, ein unbefestigter Weg nicht
road-length = Länge: { $length } m
road-count = { $roads } Straßen im Modul
road-active = { $points } Punkte gesetzt — Enter oder Rechtsklick pflastert die Straße
sel-road-summary = Straße { $index }
sel-road-named = { $name } — Straße { $index }
status-road-points = Eine Straße braucht mindestens zwei Punkte
...
check-signal-designation = Signal { $signal }: Signalbezeichnung fehlt
check-signal-interlocking = Signal { $signal }: zugehöriges Stellwerk fehlt
check-signal-addons = Signal { $signal }: Zusatzsignal-Ausstattung ist für diese Signalfunktion oder Kombination unzulässig
check-boundary-invalid = Grenze { $boundary }: Knoten fehlt oder ist kein Prellbock
check-missing-track-type = Gleis { $edge }: nennt keine Gleisart — es springt keine ein, und die Strecke lässt sich nicht übersetzen
check-unknown-track-type = Gleis { $edge }: nennt eine Gleisart, die kein installierter Mod hat
check-road-short = Straße { $road } hat weniger als zwei Punkte
...
set-aa-4x = 4 ×
set-aa-8x = 8 ×
set-upscaling = Hochskalieren
set-upscaling-hint = Zeichnet die Welt unterhalb der Bildschirmauflösung und rekonstruiert daraus das volle Bild — der größte Hebel auf schwacher Hardware. FSR 3 läuft auf jeder Grafikkarte; DLSS braucht eine NVIDIA-RTX-Karte und einen Simulator, der damit gebaut wurde.
set-upscaling-off = Aus
set-upscaling-fsr = FSR 3
set-upscaling-dlss = DLSS
set-upscaling-quality = Hochskalierstufe
...
action-detect-imagery = Aus Luftbild erkennen…
ai-title = Aus dem Luftbild erkennen
ai-intro = Lässt ein lokales Modell über das Luftbild laufen und setzt, was es findet. Nichts verlässt diesen Rechner, und geschrieben wird erst auf Kommando.
ai-model = Modell
ai-model-hint = Was laufen soll. Die Liste steht in ai.ron, neben der Luftbild-Konfiguration.
ai-model-places = Setzt: { $tags }
ai-model-missing = Gewichte nicht installiert: { $file }
ai-no-models = Kein Modell eingerichtet
ai-no-backend = Dieser Build hat keine Inferenz-Laufzeit — die vision-Kiste wurde ohne das Feature onnx gebaut.
ai-failed = Die Erkennung ist ohne Ergebnis abgebrochen — es wurde nichts gesetzt
ai-no-imagery = Es ist kein Luftbildanbieter eingerichtet
ai-no-track = Das Modul hat kein Gleis, an dem sich ein Korridor messen ließe
ai-area = Wo
ai-area-hint = Das Modell schaut nur dorthin, wohin es geschickt wird — deshalb dauert ein Lauf eine Minute und keine Stunde.
ai-area-track = Am Gleis entlang
ai-area-drawn = Im gezeichneten Bereich
ai-area-none = Noch kein Bereich gezeichnet
ai-corridor = Bis
ai-corridor-hint = Wie weit beiderseits des Gleises gesucht wird.
ai-drawn = Bereich
ai-drawn-hint = Mit dem Werkzeug „KI-Bereich“ gezeichnet oder aus dem letzten Auswahlkreis übernommen.
ai-drawn-corners = { $corners } Ecken
ai-draw-area = Bereich zeichnen
ai-keep-clear = Abstand vom Gleis
ai-keep-clear-hint = Näher als das kommt nichts an eine Schiene, gleich welcher Bereich gewählt ist.
ai-place-objects = Gefundenes setzen
ai-place-objects-hint = Ein Objekt aus den installierten Mods mit dem Tag des Modells — ein Auto für ein Auto, ein Lkw für einen Lkw.
ai-place-trees = Bäume pflanzen
ai-place-trees-hint = Was das Modell als Baumkrone liest, wird zu einem Baum aus den installierten Baum-Mods — in der Art, die das Modell genannt hat, und auf die gemessene Krone gewachsen. Danach einzeln auswählbar und löschbar wie jeder andere Baum.
ai-species = Baumarten
ai-species-hint = Woraus die Kronen werden. "Wie erkannt" nimmt die Klasse des Modells und, wo das Modell nur eine kennt, das Aussehen der Krone selbst — was bei der Auflösung eines Bilddienstes ein Hinweis ist und kein Befund. Ein Bestand überstimmt das für den ganzen Lauf.
ai-species-detected = Wie erkannt
ai-tree-spacing = Abstand der Bäume
ai-tree-spacing-hint = Wie nah ein neuer Baum an einen schon stehenden heranrücken darf. Damit ändert ein zweiter Lauf über denselben Wald nichts, statt ihn zu verdoppeln.
ai-pave-lots = Parkplätze pflastern
ai-pave-lots-hint = Autos in Reihen sind ein Parkplatz; er wird als markierungsfreie Asphaltfläche gepflastert, die sich danach wie eine Straße bearbeiten lässt.
ai-min-lot-cars = Autos je Parkplatz
ai-min-lot-cars-hint = Wie viele Autos zusammenstehen müssen, damit daraus ein Parkplatz wird und nicht nur parkende Autos.
ai-start = Starten
ai-not-ready = Ein installiertes Modell und einen Bereich wählen
ai-loading = Modell wird geladen
ai-running = Ausschnitt { $window } von { $windows } — { $found } gefunden, { $tiles } Kacheln
ai-found = { $found } gefunden
ai-found-lots = auf { $lots } Parkplätzen
ai-cost = { $windows } Ausschnitte, { $tiles } Kacheln
ai-no-objects = kein Objekt mit Tag { $tag } installiert
ai-objects-installed = { $count } zur Auswahl
status-ai-placed = { $objects } Objekte gesetzt, { $trees } Bäume gepflanzt, { $lots } Parkplätze gepflastert
status-ai-area-draw = Ecken des Bereichs klicken, Enter oder Rechtsklick schließt ihn
status-ai-area-set = Bereich mit { $corners } Ecken gesetzt — „Aus Luftbild erkennen“ erneut öffnen
status-ai-area-points = Ein Bereich braucht drei Ecken
tool-group-ai = Luftbild
tool-ai-area = KI-Bereich
tool-ai-area-hint = Der Fleck Boden, auf den ein Modell losgelassen wird: Ecken klicken, Enter oder Rechtsklick schließt den Ring
ai-open-dialog = Erkennen…
