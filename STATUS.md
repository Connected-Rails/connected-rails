...
As of 2026-08-12 · `cargo test --workspace`: **160 tests green** · clippy and fmt clean.
...
7. **Terrain streaming (ch. 4.3)** — tiles are currently built at startup; at 100 km they
...
8. **Texturing/vegetation** — the terrain is single-coloured; splatting and instancing are missing.
9. **Audio (ch. 13)** — `sim-core` already emits the events.
10. **3D cab (M6)** — the biggest chunk.
