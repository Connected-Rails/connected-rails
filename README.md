...
big the plant is — a 30 m spruce hands from leaf geometry to its whole-tree image at 105 m
...
of them. `tools/trees/bench_forest.mjs` measures what a wood costs — the checked 20,000-tree
forest over an 8 km line holds 140 fps in a debug build. Tiles are built several at a time — the
