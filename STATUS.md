...
8. **Weather rendering polish (M6 is functional)** — rain/fog/snow affect visibility,
   sky and rail; headlights follow switch and direction of travel, the cab light has
   its own switch. Open polish: red tail lamps (Zg 101), a slanted rain streak from
   the relative wind, a rain sound quantity for the sound table; instrument
   backlighting is content work per vehicle.
