...
the project); re-run the script after editing it. The cab sounds the example vehicle's
sound table plays are the exception: CC0 recordings in `assets/sounds/`, credited in
